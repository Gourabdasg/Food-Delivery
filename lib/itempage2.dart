...
class ItemDish extends StatefulWidget{
  const ItemDish({Key? key}): super(key: key);



  @override
  _ItemDish createState() => _ItemDish(); }

class _ItemDish extends State<ItemDish> {
  @override
        ...
        child: ListView(
          children: [
            ...
            Padding(padding: EdgeInsets.all(16),
              child:
              Image.asset("photos/bengali dish.jpeg",
                height:300,
                        ...
                        Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text("Teste Our Bengali Dish at low price, "
                                  "this is famous Bengali Dish and you will love it."
